...
export const selectFeeLoading = (state) => Boolean(state?.fee?.loading);
export const selectFeeActionLoading = (state) => Boolean(state?.fee?.actionLoading);
export const selectFeeError = (state) => state?.fee?.error || null;
export const selectFeeActionError = (state) => state?.fee?.actionError || null;
