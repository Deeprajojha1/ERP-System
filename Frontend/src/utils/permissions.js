...
export const resolvePermissions = (userData) => {
...
export const hasAnyPermission = (permissions = [], permissionList = []) =>
  ...
  permissionList.some((permission) => hasPermission(permissions, permission));

export const canAccessAdminPanel = (userData) => {
  const permissions = resolvePermissions(userData);
  return hasPermission(permissions, "portal.admin");
};
