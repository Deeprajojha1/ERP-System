...
export const selectAdminAlertsLoading = (state) => state.alerts.loading;
export const selectAdminAlertsSubmitting = (state) => state.alerts.submitting;
...
export const selectAdminAlertsError = (state) => state.alerts.error;
export const selectAdminAlertsNotImplemented = (state) =>
  state.alerts.notImplemented;
